  ...
  return (
    <>
      <div className="max-w-xl mx-auto bg-white rounded-lg shadow p-4 space-y-4">
        ...
        {/* Post Description */}
        <div className="text-gray-800">Science is fun</div>
      ...
      <div className="max-w-xl mx-auto bg-white rounded-lg shadow p-4 space-y-4">
        ...
        <div className="flex items-center space-x-3">
          ...
          />
          <div>
            <div className="font-semibold text-gray-900">Kusty Gate</div>
        ...
        <div className="text-gray-800">
          Ai is really gonna take over all our jobs, Funny right...
        </div>
      ...
      <div className="max-w-xl mx-auto bg-white rounded-lg shadow p-4 space-y-4">
        ...
        <div className="flex items-center space-x-3">
          ...
          />
          <div>
            <div className="font-semibold text-gray-900">Lang Chan</div>
            <div className="text-xs text-gray-500">4 hours ago</div>
          </div>
        </div>

        {/* Post Description */}
        <div className="text-gray-800">Math is fun</div>
      ...
      <div className="max-w-xl mx-auto bg-white rounded-lg shadow p-4 space-y-4">
        ...
        <div className="flex items-center space-x-3">
          ...
          />
          <div>
            <div className="font-semibold text-gray-900">Jake Smatle</div>
            <div className="text-xs text-gray-500">4 hours ago</div>
          </div>
        </div>

        {/* Post Description */}
        <div className="text-gray-800">Ai is the actual future</div>
      ...
      <div className="max-w-xl mx-auto bg-white rounded-lg shadow p-4 space-y-4">
        ...
        <div className="flex items-center space-x-3">
          ...
          />
          <div>
            <div className="font-semibold text-gray-900">Louis Jambo</div>
            <div className="text-xs text-gray-500">4 hours ago</div>
          </div>
        </div>
        ...
        {/* Post Description */}
        <div className="text-gray-800">
          Nature and Science are quite similar, they both are beautiful
        </div>
  ...
  return (
    <>
      {posts.map((post) => (
        <div
          key={post.id}
          className="max-w-xl mx-auto bg-white rounded-lg shadow p-4 space-y-4"
        >
          {/* Post Header */}
          <div className="flex items-center space-x-3">
            <img
